...
//innerHeight repesents the interior height
...
//function to make sure that the zie of the elements in the game are responsive and adapt to different screen sizes
...
class Player{
    constructor() {
        ...
        //velocity property will be used to store the player's speed in the x and y directions
        this.velocity = {
            x: 0,
            y: 0,
        };
...
class Platform{
    constructor(x, y){
        //shorthand porperty
            //This sintax allows you to omit the property value if it's the same as the property name
            //the same that:
                //this.position = {
                //   x: x,
                //   y: y
...
//responsible for updating the player's position and continually drawing it on the canvas
const animate = () => {
    //web API, is used to update the animation on the screen
    requestAnimationFrame(animate);
    //web API, will clear the ccanvas before rendering the next frame of the animation
